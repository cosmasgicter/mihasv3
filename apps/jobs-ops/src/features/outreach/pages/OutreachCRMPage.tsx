...
export function OutreachCRMPage() {
  ...
  const isLoading = contactsQuery.isLoading || campaignsQuery.isLoading || analyticsQuery.isLoading
  const errorQuery = contactsQuery.isError ? contactsQuery : campaignsQuery.isError ? campaignsQuery : analyticsQuery.isError ? analyticsQuery : null
          ...
          <SectionCard title="Priority contacts">
            <div className="grid gap-4">
              {contacts.map((contact) => (
                <div key={contact.id} className="rounded-[28px] border border-line/70 bg-panel/90 p-5 shadow-sm">
          ...
          <SectionCard title="Campaign pulse">
            <div className="grid gap-3">
              {campaigns.map((campaign) => (
                <div key={campaign.id} className="rounded-[24px] border border-line/70 bg-panel/85 p-4">
