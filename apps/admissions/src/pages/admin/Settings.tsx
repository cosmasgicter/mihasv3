...
const SETTING_BLUEPRINTS: SettingBlueprint[] = [
  ...
  { key: 'contact_email', label: 'Admissions email', description: 'Primary email used for admissions contact, slip delivery, and public support messaging.', category: 'contact', valueType: 'string', placeholder: 'admissions@beanola.com', is_public: true },
