      ...
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="features-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
  ...
  return (
    ...
    >
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="how-it-works-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
          ...
          <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {applicationFees.map((fee) => (
              <div key={fee.audience} className="rounded-md border border-border bg-card p-4">
                <p className="text-sm font-medium text-muted-foreground">{fee.audience}</p>
                <p className="mt-1 text-2xl font-semibold text-foreground">{fee.amount}</p>
                <p className="mt-1 text-xs leading-5 text-muted-foreground">{fee.note}</p>
              </div>
            ))}
          </div>
  ...
  return (
    ...
    >
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="eligibility-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
            ...
            <StaggerItem key={accred.title}>
              <Card className="h-full rounded-lg border border-border bg-card shadow-sm">
                <CardContent className="p-5">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg border border-border bg-muted p-2">
                    <OptimizedImage
  ...
  return (
    ...
    >
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="programs-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
  ...
  return (
    ...
    >
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="accommodation-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
  ...
  return (
    ...
    >
      <div className="container-responsive px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="mb-10 max-w-3xl sm:mb-12">
          <TextEffect effect="fadeUp">
            <h2 id="international-heading" className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl lg:text-4xl">
    ...
    >
      <ScrollReveal className="container-responsive grid gap-6 px-4 text-white sm:px-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:text-left lg:px-8">
        ...
        <Button
          ...
          variant="secondary"
          size="lg"
          className="min-h-[48px] bg-card px-6 font-semibold text-foreground shadow-sm hover:bg-muted sm:px-8"
        >
          <Link
            to="/auth/signup"
            onPointerEnter={warmAuthRoutes}
