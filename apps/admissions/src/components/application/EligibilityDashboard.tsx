    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <select
          ...
          className="px-3 py-2 border border-input rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
