  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-2 border-t border-border pt-4">
        <Button variant="outline" size="sm" className="min-h-touch min-w-touch" onClick={() => onEdit(user)}>
          Edit
        </Button>
        <Button variant="outline" size="sm" className="min-h-touch min-w-touch" onClick={() => onPermissions(user)}>
          Permissions
        </Button>
        <Button variant="outline" size="sm" className="min-h-touch min-w-touch" onClick={() => onActivity(userId)}>
          Activity
        </Button>
        {user.role !== 'super_admin' && (
          <Button variant="outline" size="sm" className="min-h-touch min-w-touch border-destructive/30 text-destructive hover:bg-destructive/5" onClick={() => onDeactivate(user)}>
            Deactivate
          </Button>
        )}
      </div>
