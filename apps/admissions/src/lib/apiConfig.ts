const PRODUCTION_APP_ORIGIN = 'https://apply.beanola.com'
const PRODUCTION_API_ORIGIN = 'https://api.beanola.com'
...
export function getApiBaseUrl(): string {
  ...
  if (configuredBaseUrl) {
    ...
    // (e.g. https://apply.beanola.com), fall through to the origin-based
