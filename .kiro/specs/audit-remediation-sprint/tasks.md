...
- [x] 1. Fix CSRF password-reset/confirm exempt pattern (P1-SEC-020)
...
- [x] 2. Add CSRF token expiry check (P1-SEC-018)
...
- [x] 3. Add CSRF user binding (P1-SEC-019)
...
- [x] 4. Set RATELIMIT_FAIL_OPEN and add try/except (P1-SEC-014)
...
- [x] 5. Fix frontend error reporter URL (P1-SEC-023)
...
- [x] 6. Change error reporter to opt-out default (P1-SEC-024)
...
- [x] 7. Add CSRF token generation to RefreshView (P1-SEC-009)
...
- [x] 9. Expand rate limiting scopes (P1-SEC-013, P1-SEC-012)
...
- [x] 10. Add CSRF cleanup to logout and periodic task (P1-SEC-021, cleanup)
...
- [x] 11. Add PaymentStatusUpdateSerializer (P1-SEC-027)
...
- [x] 12. Add select_related to key querysets (P3-DB-001)
...
- [x] 14. Install pg_stat_statements on Neon
...
- [x] 15. Add documentation comments to base.py (P1-SEC-005, P1-SEC-010)
