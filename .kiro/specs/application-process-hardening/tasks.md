...
- [ ] 1. Backend security hardening
  - [ ] 1.1 Add webhook replay protection to WebhookProcessor
  ...
  - [ ] 1.2 Wire submission idempotency using existing idempotency_keys table
  ...
  - [ ] 1.3 Add idempotency key header to frontend wizard submission
  ...
  - [ ] 1.4 Harden error report endpoint
  ...
  - [ ] 1.5 Add force-bypass audit logging to ApplicationReviewView
  ...
  - [ ] 1.6 Write property tests for security hardening (backend)
...
- [ ] 2. Checkpoint — Security hardening
  - Run `cd backend && python3 -m pytest` and verify all tests pass

- [ ] 3. Backend performance and validation
  - [ ] 3.1 Increase pagination max_page_size from 100 to 500
  ...
  - [ ] 3.4 Add backend age validation
  ...
  - [ ] 3.6 Add application status state machine enforcement
  ...
  - [ ] 3.7 Write property tests for validation and state machine (backend)
...
- [ ] 4. Checkpoint — Performance and validation
  - Run `cd backend && python3 -m pytest` and verify all tests pass

- [ ] 5. Frontend improvements
  - [ ] 5.1 Add error reporter deduplication
  ...
  - [ ] 5.2 Implement exponential backoff in usePaymentStatus
  ...
  - [ ] 5.3 Update wizard phone input for international numbers
  ...
  - [ ] 5.4 Write property tests for frontend improvements
...
- [ ] 6. Checkpoint — Frontend improvements
  - Run `cd apps/admissions && bun run test` and verify all tests pass

- [ ] 7. Accessibility improvements
  - [ ] 7.1 Enhance wizard step aria-live announcements
  ...
  - [ ] 7.2 Add payment error recovery accessibility
  ...
  - [ ] 7.3 Add keyboard navigation to admin applications grid
  ...
  - [ ] 7.4 Improve validation error focus management
  ...
  - [ ] 7.5 Fix error display color contrast
