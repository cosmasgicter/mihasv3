...
- `***REMOVED***/api/health` - Basic health check
- `***REMOVED***/api/health?action=ping` - Ping/pong
- `***REMOVED***/api/health?action=arcjet` - Arcjet test
- `***REMOVED***/api/auth?action=session` - Auth session
