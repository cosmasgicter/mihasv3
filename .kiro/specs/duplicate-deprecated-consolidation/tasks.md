...
- [x] 1. Phase 1 — Foundation Utilities: Consolidate general utilities and accessibility helpers
  ...
  - [x] 1.2 Consolidate accessibility helpers into `src/lib/accessibility-utils.ts`
  ...
  - [x] 1.3 Write property test for single canonical source (Property 1)
  ...
  - [x] 1.4 Write property test for canonical module export completeness (Property 2)
...
- [x] 2. Phase 1 — Foundation Utilities: Consolidate sanitization, logger, and error messages
  - [x] 2.1 Consolidate sanitization modules into `src/lib/sanitize/index.ts`
  ...
  - [x] 2.2 Write property test for sanitization neutralizes XSS and protects PII (Property 6)
  ...
  - [x] 2.3 Consolidate logger into `src/lib/logger.ts`
  ...
  - [x] 2.4 Write property test for logger structured entries (Property 14)
  ...
  - [x] 2.5 Consolidate error messages into `src/lib/errorMessages.ts`
...
- [x] 3. Phase 1 — Foundation Utilities: Consolidate draft manager and security modules
  - [x] 3.1 Consolidate draft management into `src/lib/draftManager.ts`
  ...
  - [x] 3.2 Write property test for DraftManager deduplication (Property 16)
  ...
  - [x] 3.3 Consolidate security modules into `src/lib/securityConfig.ts`
...
- [x] 5. Phase 2 — Hooks & Services: Consolidate error handling, loading state, and network hooks
  - [x] 5.1 Consolidate error handling hooks
  ...
  - [x] 5.2 Write property test for error handler capabilities (Property 15)
  ...
  - [x] 5.3 Consolidate loading state implementations
  ...
  - [x] 5.4 Consolidate network status and offline modules
...
- [x] 6. Phase 2 — Hooks & Services: Consolidate application hooks, notification hooks, toast, draft hook, and notification service
  - [x] 6.1 Consolidate application data hooks
  ...
  - [x] 6.2 Write property test for React Query cache keys preserved (Property 13)
  ...
  - [x] 6.3 Consolidate notification preferences hook
  ...
  - [x] 6.4 Consolidate draft management hook
  ...
  - [x] 6.5 Write property test for auto-save interval preserved (Property 8)
  ...
  - [x] 6.6 Eliminate redundant toast store re-exports
  ...
  - [x] 6.7 Consolidate notification service implementations
...
- [x] 8. Phase 3 — UI Components: Consolidate skeleton components, error boundaries, and responsive layout
  - [x] 8.1 Consolidate DashboardSkeleton into `src/components/ui/skeletons/DashboardSkeleton.tsx`
  ...
  - [x] 8.2 Consolidate ErrorBoundary into `src/components/ui/ErrorBoundary.tsx`
  ...
  - [x] 8.3 Consolidate ResponsiveLayout into `src/components/ui/ResponsiveLayout.tsx`
  ...
  - [x] 8.4 Consolidate remaining duplicate UI components
  ...
  - [x] 8.5 Write property test for focus trap behavior (Property 7)
...
- [x] 10. Phase 4 — Dead Code Removal: Delete files with zero import references
  - [x] 10.1 Delete dead utility and lib files
  ...
  - [x] 10.4 Delete dead admin modules, hooks, services, and deprecated shims
  ...
  - [x] 10.5 Verify `src/utils/` directory status
  ...
  - [x] 10.6 Write property test for deprecated and dead files deleted (Property 4)
  ...
  - [x] 10.7 Write property test for no imports from deprecated paths (Property 3)
...
- [x] 12. Phase 5 — Async Effect Hardening: Add cancellation guards and cleanup
  - [x] 12.1 Add AbortController guards to fetch-based useEffect hooks
  ...
  - [x] 12.2 Add timer cleanup to interval/timeout-based effects
  ...
  - [x] 12.3 Add event listener cleanup and replace deprecated MediaQueryList API
  ...
  - [x] 12.4 Write property test for async effects have proper cleanup (Property 9)
  ...
  - [x] 12.5 Write property test for no deprecated MediaQueryList API (Property 10)
...
- [x] 14. Phase 6 — ESLint Enforcement: Add no-restricted-imports rules
  - [x] 14.1 Add `no-restricted-imports` rules for all deprecated paths
  ...
  - [x] 14.2 Write property test for ESLint rules cover all deprecated paths (Property 11)
  ...
  - [x] 14.3 Verify lint passes with zero violations
    - Run `bun run lint` and confirm zero violations from the new `no-restricted-imports` rules
    - _Requirements: 8.5_

  - [x] 14.4 Write property test for no database DDL in frontend code (Property 12)
