...
- [ ] 3. Add new SQL scripts for receipt uniqueness and user-status index
...
- [ ] 4. Write the Payment_Snapshot backfill script
...
- [ ] 5. Apply Phase 1 schema and backfill in staging
  ...
  - [ ]* 5.2 Document rollback procedure for Phase 1
...
- [ ] 6. Regression preservation — Phase 1
  ...
  - [-] 6.2 Regression test — no API route, filename, or envelope drift
...
- [ ] 7. Phase 1 verification block
  - Run the design's verification commands in order and confirm no regressions.
  - _Requirements: R22.6, R22.7_

  - [~] 7.1 Run `cd apps/admissions && bun run type-check`
    - _Requirements: R22.6_

  - [~] 7.2 Run `cd apps/admissions && bun run lint`
    - _Requirements: R22.6_

  - [~] 7.3 Run `cd backend && python3 -m pytest backend/tests/ -k payment`
    - _Requirements: R22.6_

  - [~] 7.4 Run `cd backend && python3 -m pytest backend/tests/property/ -k payment`
    - _Requirements: R20.1, R20.2, R20.3, R20.4, R20.5, R20.6, R20.7, R20.8, R20.9, R20.10, R20.11, R20.12_

  - [~] 7.5 Run `cd apps/admissions && bun run build`
    - _Requirements: R22.6_
...
- [ ] 9. File ADR-1 through ADR-7 before Phase 2 ships
  ...
  - [ ] 9.1 File `docs/adrs/ADR-001-payment-is-source-of-truth.md`
  ...
  - [ ] 9.2 File `docs/adrs/ADR-002-force-approved-distinct-status.md`
  ...
  - [ ] 9.3 File `docs/adrs/ADR-003-reuse-audit-logs.md`
  ...
  - [ ] 9.4 File `docs/adrs/ADR-004-canonical-json-webhook-dedup.md`
  ...
  - [ ] 9.5 File `docs/adrs/ADR-005-metadata-jsonb-over-new-columns.md`
...
- [ ] 10. TDD — write `_transition()` transition-matrix tests before refactoring `payment_service.py`
  ...
  - [ ] 10.1 Unit test — explicit allowed/blocked transitions per source
  ...
  - [ ] 10.2 Unit test — application-summary sync occurs inside the same atomic
    - File: `backend/tests/unit/test_payment_service_transitions.py`.
  ...
  - [ ] 10.3 Unit test — sole authority grep guard
  ...
  - [ ] 10.4 Unit test — admin review cannot reverse a successful Payment
  ...
  - [ ] 10.5 Unit test — integrity gate blocks mismatched successful transitions
    - File: `backend/tests/unit/test_payment_service_transitions.py`.
...
- [ ] 11. Refactor `payment_service.py` so `_transition()` is the sole mutation entry point
  ...
  - [ ] 11.1 Add `PaymentSnapshot` and `TransitionResult` dataclasses
  ...
  - [ ] 11.2 Implement `_transition(payment, target_status, *, source, actor, reason=None, provider_data=None)`
  ...
  - [ ] 11.3 Implement `_emit_audit(event_type, payment, actor, metadata)`
  ...
  - [ ] 11.4 Implement `_generate_receipt_idempotent(payment)`
  ...
  - [ ] 11.5 Refactor `initiate(application_id, user_id)` onto `_transition`
  ...
  - [ ] 11.6 Implement `initiate_mobile_money(application_id, user_id, phone_raw)`
  ...
  - [ ] 11.7 Implement `verify(payment_id, actor_id)`
  ...
  - [ ] 11.8 Implement `apply_webhook_event(event_type, reference, payload)`
  ...
  - [ ] 11.9 Implement `force_approve(application_id, actor_id, actor_role, reason)`
  ...
  - [ ] 11.10 Implement `expire_stale(older_than_hours=24, batch_cap=50)`
  ...
  - [ ] 11.11 Unit test — `initiate_mobile_money` phone normalisation edge cases
  ...
  - [ ] 11.12 Unit test — `force_approve` happy path and guards
  ...
  - [ ] 11.13 Unit test — `expire_stale` idempotence
...
- [ ] 12. Write the `PaymentAuditService` wrapper module
  ...
  - [ ] 12.1 Create `backend/apps/documents/payment_audit_service.py`
  ...
  - [ ] 12.2 Unit test — audit row shape and retention category
  ...
  - [ ] 12.3 Unit test — PII redaction property
...
- [ ] 13. Write the `MetricsService` counter registry
  ...
  - [ ] 13.1 Create `backend/apps/documents/payment_metrics.py`
  ...
  - [ ] 13.2 Unit test — counter registry completeness
  ...
  - [ ] 13.3 Unit test — PII guardrail on label values
    - File: `backend/tests/unit/test_payment_metrics_registry.py`.
...
- [ ] 14. Wire PaymentService + AuditService + MetricsService into the existing views
  ...
  - [ ] 14.1 Refactor `PaymentInitiateView` in `backend/apps/documents/views.py`
  ...
  - [ ] 14.2 Refactor `MobileMoneyInitiateView`
  ...
  - [ ] 14.3 Refactor `PaymentVerifyView`
  ...
  - [ ] 14.5 Refactor `ApplicationReviewView` (admin override path)
  ...
  - [ ] 14.6 Refactor `poll_pending_payments_task` in `backend/apps/documents/tasks.py`
  ...
  - [ ] 14.7 Unit test — envelope contract across all payment endpoints
...
- [ ] 15. Add the `PAYMENT_HARDENING_FORWARD_ONLY` feature flag plumbing
  - _Requirements: R1.7, R22.6_

  - [ ] 15.1 Declare `PAYMENT_HARDENING_FORWARD_ONLY` in `backend/config/settings/base.py`
    - Default `False`; read from `PAYMENT_HARDENING_FORWARD_ONLY` env var.
    - _Requirements: R1.7_

  - [ ] 15.2 Gate `_transition()` enforcement on the flag
...
- [ ] 16. Enforcement PBTs for Phase 2
  ...
  - [ ] 16.1 PBT — Property 1: Race-Safe Concurrent Initiation (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.2 PBT — Property 2: Terminal Stability (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.3 PBT — Property 5: Amount/Currency/Reference Integrity (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 16.4 PBT — Property 13: Application Summary Consistency (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.5 PBT — Property 14: Forward-Only Transition Closure (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.6 PBT — Property 19: Retry Limit Threshold (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.7 PBT — Property 23: Snapshot Immutability (enforcement)
    - File: `backend/tests/property/test_payment_state_machine_properties.py`.
  ...
  - [ ] 16.8 PBT — Property 10: Fee Resolver Determinism (enforcement)
    - File: `backend/tests/property/test_payment_fee_resolver_properties.py`.
  ...
  - [ ] 16.9 PBT — Property 11: Tamper-Resistance (enforcement)
    - File: `backend/tests/property/test_payment_fee_resolver_properties.py`.
  ...
  - [ ] 16.10 PBT — Property 12: Provider Uncertainty Keeps Pending (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
  ...
  - [ ] 16.11 PBT — Property 16: Phone Normalization Idempotence (enforcement)
    - File: `backend/tests/property/test_payment_fee_resolver_properties.py`.
  ...
  - [ ] 16.12 PBT — Property 15: Payment-Sensitive Fields Locked (enforcement)
    - File: `backend/tests/property/test_payment_fee_resolver_properties.py`.
...
- [ ] 17. Unit tests for Phase 2 supporting behaviour
  ...
  - [ ] 17.1 Unit test — sensitive-field lock on application PATCH/DELETE
  ...
  - [ ] 17.2 Unit test — receipt generation eligibility + force-approved label
  ...
  - [ ] 17.3 Unit test — dev-bypass lockout under production settings
  ...
  - [ ] 17.4 Unit test — reconciliation task behaviour
...
- [ ] 18. Regression preservation — Phase 2
  - _Requirements: R22.6_

  - [ ] 18.1 Regression test — `normalizePaymentStatus` still maps legacy `verified` and `paid` to verified
  ...
  - [ ] 18.2 Regression test — Lenco widget branch still invokes `LencoPay.getPaid`
  ...
  - [ ] 18.3 Regression test — mobile-money-first wizard UX preserved
...
- [ ] 19. Phase 2 verification block
  - _Requirements: R22.6, R22.7_

  - [ ] 19.1 Run `cd apps/admissions && bun run type-check`
    - _Requirements: R22.6_

  - [ ] 19.2 Run `cd apps/admissions && bun run lint`
    - _Requirements: R22.6_

  - [ ] 19.3 Run `cd backend && python3 -m pytest backend/tests/ -k payment`
    - _Requirements: R22.6_

  - [ ] 19.4 Run `cd backend && python3 -m pytest backend/tests/property/ -k payment`
    - _Requirements: R20.1, R20.2, R20.3, R20.4, R20.5, R20.6, R20.7, R20.8, R20.9, R20.10, R20.11, R20.12_

  - [ ] 19.5 Run `cd apps/admissions && bun run build`
    - _Requirements: R22.6_
...
- [ ] 21. Implement canonical JSON and `WebhookEventIdentity` in `webhook_processor.py`
  ...
  - [ ] 21.1 Add `canonical_json(payload)` helper
  ...
  - [ ] 21.2 Add frozen `WebhookEventIdentity` dataclass with `print()` / `parse()`
  ...
  - [ ] 21.3 Implement `compute_identity(event_type, payload)`
  ...
  - [ ] 21.4 Implement `is_duplicate(identity)`
  ...
  - [ ] 21.5 Rewire `process(raw_body, signature, payload)`
...
- [ ] 22. Write stable error code catalogues for backend and frontend
  ...
  - [ ] 22.1 Create `backend/apps/documents/payment_error_codes.py`
  ...
  - [ ] 22.2 Create `apps/admissions/src/lib/paymentErrorCodes.ts`
  ...
  - [ ] 22.3 Unit test — snapshot pin of stable codes (backend)
  ...
  - [ ] 22.4 Unit test — frontend union matches backend catalogue
...
- [ ] 23. Add the `PAYMENT_HARDENING_WEBHOOK_DEDUP_STRICT` feature flag
  - _Requirements: R8.5, R8.6, R12.4_

  - [ ] 23.1 Declare `PAYMENT_HARDENING_WEBHOOK_DEDUP_STRICT` in `backend/config/settings/base.py`
    - Default `False`; read from env var.
    - _Requirements: R8.5, R8.6_

  - [ ] 23.2 Gate strict dedup behaviour on the flag
...
- [ ] 24. Enforcement PBTs for Phase 3
  ...
  - [ ] 24.1 PBT — Property 3: Out-Of-Order Webhook Safety (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 24.2 PBT — Property 4: Webhook Idempotence (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 24.3 PBT — Property 20: Canonical JSON Round-Trip (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 24.4 PBT — Property 21: Webhook Identity Round-Trip (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 24.5 PBT — Property 22: Provider Event Id Preferred In Identity (enforcement)
    - File: `backend/tests/property/test_payment_webhook_properties.py`.
  ...
  - [ ] 24.6 PBT — Property 6: Receipt Idempotence (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
  ...
  - [ ] 24.7 PBT — Property 7: Single-Active DB Invariant (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
  ...
  - [ ] 24.8 PBT — Property 8: Transaction Reference Uniqueness (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
  ...
  - [ ] 24.9 PBT — Property 9: Receipt Number Uniqueness (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
  ...
  - [ ] 24.10 PBT — Property 17: PII Redaction (enforcement)
    - File: `backend/tests/property/test_payment_receipt_properties.py`.
...
- [ ] 25. Unit tests for Phase 3 supporting behaviour
  - _Requirements: R8.1, R8.2, R8.3, R8.4, R8.5, R8.6, R8.7, R9.1, R9.2, R9.3, R9.4, R21.5, R22.5_

  - [ ] 25.1 Unit test — HMAC signature validation paths
  ...
  - [ ] 25.2 Unit test — dedup provider-event-id preference and canonical fallback
  ...
  - [ ] 25.3 Unit test — out-of-order webhook safety end-to-end
  ...
  - [ ] 25.4 Unit test — canonical serialization failure
  ...
  - [ ] 25.5 Unit test — webhook unknown event type is logged, not mutating
  ...
  - [ ] 25.6 Unit test — structured logging + GlitchTip tagging
...
- [ ] 26. Standardize backend error envelope responses across payment endpoints
  - _Requirements: R10.7, R15.1, R15.2, R15.4, R15.5_

  - [ ] 26.1 Apply the Stable Code Catalog to every payment endpoint's error paths
  ...
  - [ ] 26.2 Unit test — stable-code coverage across payment endpoints
...
- [ ] 27. Regression preservation — Phase 3
  - _Requirements: R22.6_

  - [ ] 27.1 Regression test — existing `/api/v1/payments/webhook/lenco/` still returns 200 on any outcome
  ...
  - [ ] 27.2 Regression test — envelope shape unchanged on resolve-fee
...
- [ ] 28. Phase 3 verification block
  - _Requirements: R22.6, R22.7_

  - [ ] 28.1 Run `cd apps/admissions && bun run type-check`
    - _Requirements: R22.6_

  - [ ] 28.2 Run `cd apps/admissions && bun run lint`
    - _Requirements: R22.6_

  - [ ] 28.3 Run `cd backend && python3 -m pytest backend/tests/ -k payment`
    - _Requirements: R22.6_

  - [ ] 28.4 Run `cd backend && python3 -m pytest backend/tests/property/ -k payment`
    - _Requirements: R20.1, R20.2, R20.3, R20.4, R20.5, R20.6, R20.7, R20.8, R20.9, R20.10, R20.11, R20.12, R21.2, R21.4_

  - [ ] 28.5 Run `cd apps/admissions && bun run build`
    - _Requirements: R22.6_

  - [ ] 28.6 Run `bun audit`
    - _Requirements: R22.6_

- [ ] 29. Documentation updates after Phase 3
  - _Requirements: R22.5, R22.6, R22.7_

  - [ ] 29.1 Update `.kiro/steering/tech.md`
  ...
  - [ ] 29.2 Update `.kiro/steering/structure.md`
  ...
  - [ ] 29.3 Update `docs/runbooks/secrets-rotation.md`
  ...
  - [ ] 29.4 Update `docs/redis-dependency-tiers.md`
...
- [ ] 30. Checkpoint — Phase 3 complete
...
- [ ] 31. Create the `paymentErrorCodes.ts` stable-code module and user-facing copy map
  ...
  - [ ] 31.1 Create `apps/admissions/src/lib/paymentErrorCodes.ts`
  ...
  - [ ] 31.2 Create `apps/admissions/src/lib/paymentNextActions.ts`
  ...
  - [ ] 31.3 Unit test — stable-code coverage snapshot
...
- [ ] 32. Add the `zambianMsisdn.ts` Zod refinement
  ...
  - [ ] 32.1 Create `apps/admissions/src/lib/zambianMsisdn.ts`
  ...
  - [ ] 32.2 Create `apps/admissions/tests/property/paymentErrorCodes.property.test.ts`
...
- [ ] 33. Create the `paymentRecoveryStore` Zustand slice
  ...
  - [ ] 33.1 Create `apps/admissions/src/stores/paymentRecoveryStore.ts`
  ...
  - [ ] 33.2 Create `apps/admissions/tests/property/paymentRecoveryStore.property.test.ts`
  ...
  - [ ] 33.3 Unit test — recovery store survives page refresh via localStorage
  ...
  - [ ]* 33.4 Unit test — recovery store concurrent-tab safety
...
- [ ] 34. Implement the `derivePaymentUiState` pure function and UI state enum
  ...
  - [ ] 34.1 Extend `apps/admissions/src/lib/paymentStatus.ts`
  ...
  - [ ] 34.2 Unit test — exhaustive UI state matrix table
...
- [ ] 35. Promote Property 18 to enforcement PBT in `paymentStateMachine.property.test.ts`
  ...
  - [ ] 35.1 Convert `apps/admissions/tests/property/paymentStateMachine.property.test.ts` to enforcement
...
- [ ] 36. Refactor `PaymentForm.tsx` for button-disable-while-inflight and idempotency-key header
  ...
  - [ ] 36.1 Add `generateIdempotencyKey` helper
  ...
  - [ ] 36.2 Refactor `apps/admissions/src/components/student/PaymentForm.tsx`
  ...
  - [ ] 36.3 Update `apps/admissions/src/services/payments.ts`
  ...
  - [ ] 36.4 Unit test — button disabled while inflight and while pending
  ...
  - [ ]* 36.5 Unit test — idempotency key header is present per submission
...
- [ ] 37. Refactor `usePaymentStatus` to emit `still_confirming` on polling timeout
  ...
  - [ ] 37.1 Refactor `apps/admissions/src/hooks/usePaymentStatus.ts`
  ...
  - [ ] 37.2 Unit test — polling timeout sets `pollingExceededTimeout`, not `failed`
  ...
  - [ ]* 37.3 Unit test — refetch resumes polling and clears timeout
...
- [ ] 38. Render the UI state matrix in `PaymentStep.tsx` behind `VITE_PAYMENT_HARDENING_UI`
  ...
  - [ ] 38.1 Add `VITE_PAYMENT_HARDENING_UI` environment wiring
  ...
  - [ ] 38.2 Refactor `apps/admissions/src/pages/student/applicationWizard/steps/PaymentStep.tsx`
  ...
  - [ ] 38.3 Component test — each `PaymentUiState` renders the correct affordances
  ...
  - [ ] 38.4 Component test — mount rehydration from `paymentRecoveryStore`
...
- [ ] 39. Regression preservation — Phase 4
  ...
  - [ ] 39.1 Regression test — PaymentStep legacy mode unchanged
  ...
  - [ ] 39.2 Regression test — `usePaymentStatus` timeout never produces `failed`
  ...
  - [ ] 39.3 Regression test — settings dirty-state protection preserved
  ...
  - [ ] 39.4 Regression test — accessibility: focus-on-state-change, aria-live, ErrorDisplay semantics
  ...
  - [ ] 39.5 Regression test — mobile-money tab is the primary tab
...
- [ ] 40. Phase 4 verification block
  - Run the six-command verification sequence and confirm no regressions.
  - _Requirements: R22.6, R22.7_

  - [ ] 40.1 Run `cd apps/admissions && bun run type-check`
    - _Requirements: R22.6_

  - [ ] 40.2 Run `cd apps/admissions && bun run lint`
    - _Requirements: R22.6_

  - [ ] 40.3 Run `cd backend && python3 -m pytest backend/tests/ -k payment`
    - _Requirements: R22.6_

  - [ ] 40.4 Run `cd apps/admissions && bun run test -- --run tests/property/payment && cd ../../backend && python3 -m pytest backend/tests/property/ -k payment`
    - _Requirements: R14.1, R14.2, R14.3, R14.6, R14.7, R20.1_

  - [ ] 40.5 Run `cd apps/admissions && bun run build`
    - _Requirements: R22.6_
...
- [ ] 43. Implement `@require_not_dev_bypass_in_production` decorator and audit emission
  ...
  - [ ] 43.1 Create `backend/apps/common/dev_bypass.py`
  ...
  - [ ] 43.2 Apply the decorator to every payment view
  ...
  - [ ] 43.3 Unit test — production routing returns 404 on any dev-bypass vector
  ...
  - [ ] 43.4 Unit test — non-production emits `payment.dev_bypass_used` audit
  ...
  - [ ]* 43.5 Unit test — decorator never mutates non-production routing
...
- [ ] 44. Configure DRF `ScopedRateThrottle` with per-scope budgets gated on `PAYMENT_HARDENING_RATE_LIMITS`
  ...
  - [ ] 44.1 Declare `PAYMENT_HARDENING_RATE_LIMITS` flag and throttle scopes in `backend/config/settings/base.py`
    - Default `False`; read from env var.
  ...
  - [ ] 44.2 Wire `throttle_classes` and `throttle_scope` into payment views
  ...
  - [ ] 44.3 Map 429 responses to the `RATE_LIMITED` stable code
  ...
  - [ ] 44.4 Unit test — per-scope rate limit enforcement
  ...
  - [ ] 44.5 Unit test — webhook is not throttled
  ...
  - [ ] 44.6 Unit test — flag default preserves current behaviour
  ...
  - [ ] 44.7 Unit test — 429 envelope + audit + counter
...
- [ ] 45. Remove the synthetic zero-amount successful Payment path behind `PAYMENT_HARDENING_FORCE_APPROVED`
  ...
  - [ ] 45.1 Declare `PAYMENT_HARDENING_FORCE_APPROVED` flag in `backend/config/settings/base.py`
  ...
  - [ ] 45.2 Gate `ApplicationReviewView` admin verification path on the flag
  ...
  - [ ] 45.3 Unit test — force-approved path creates canonical ledger row
  ...
  - [ ] 45.4 Unit test — reason < 10 chars rejected with `OVERRIDE_REASON_REQUIRED`
  ...
  - [ ] 45.5 Unit test — legacy synthetic path preserved when flag is off
...
- [ ] 46. Build the `SuperAdminPaymentCorrectionView` correction endpoint
  ...
  - [ ] 46.1 Create `SuperAdminPaymentCorrectionView` in `backend/apps/documents/views.py`
  ...
  - [ ] 46.2 Unit test — super-admin-only access
  ...
  - [ ] 46.3 Unit test — reason guard and audit ordering
  ...
  - [ ] 46.4 Unit test — route does not conflict with `/verify/`
...
- [ ] 47. Build the super-admin-only risk-flag inspection endpoint in `risk_views.py`
  ...
  - [ ] 47.1 Create `backend/apps/documents/risk_views.py`
  ...
  - [ ] 47.2 Register the URL in `backend/apps/documents/urls.py`
  ...
  - [ ] 47.3 Unit test — permission matrix
  ...
  - [ ] 47.4 Unit test — filtering by type and date range
  ...
  - [ ]* 47.5 Unit test — details PII redaction
    - File: `backend/tests/unit/test_payment_risk_flags_endpoint.py` (extend).
...
- [ ] 48. Add the dev-bypass lockout assertion tests per `require_not_dev_bypass_in_production` surface
  ...
  - [ ] 48.1 Unit test — new Phase 5 endpoints return 404 on dev-bypass under production
...
- [ ] 49. Regression preservation — Phase 5
  ...
  - [ ] 49.1 Regression test — rate-limit flag default preserves current behaviour
  ...
  - [ ] 49.2 Regression test — legacy synthetic admin verification preserved when `PAYMENT_HARDENING_FORCE_APPROVED=False`
  ...
  - [ ] 49.3 Regression test — dev-bypass lockout never alters non-production behaviour absent a bypass flag
  ...
  - [ ] 49.4 Regression test — `SuperAdminPaymentCorrectionView` path is non-conflicting
...
- [ ] 50. Phase 5 verification block
  - Run the six-command verification sequence and confirm no regressions.
  - _Requirements: R22.6, R22.7_

  - [ ] 50.1 Run `cd apps/admissions && bun run type-check`
    - _Requirements: R22.6_

  - [ ] 50.2 Run `cd apps/admissions && bun run lint`
    - _Requirements: R22.6_

  - [ ] 50.3 Run `cd backend && python3 -m pytest backend/tests/ -k payment`
    - _Requirements: R22.6_

  - [ ] 50.4 Run `cd backend && python3 -m pytest backend/tests/property/ -k payment`
    - _Requirements: R20.1, R20.2, R20.3, R20.4, R20.5, R20.6, R20.7, R20.8, R20.9, R20.10, R20.11, R20.12, R21.2, R21.4_

  - [ ] 50.5 Run `cd apps/admissions && bun run build`
    - _Requirements: R22.6_
...
- [ ] 52. Documentation updates after Phase 5
  - _Requirements: R22.5, R22.6, R22.7_

  - [ ] 52.1 Update `.kiro/steering/tech.md`
  ...
  - [ ] 52.2 Update `.kiro/steering/structure.md`
  ...
  - [ ] 52.3 Update `docs/runbooks/payment-hardening-rollout.md`
...
- [ ] 53. Final checkpoint — Phase 5 complete, payment hardening fully shipped
