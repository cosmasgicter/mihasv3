...
ScoutQA production audit of the MIHAS admissions landing page (***REMOVED***) scored 94/100 (A-) but identified two issues: accreditation logo images failing to render (naturalWidth/naturalHeight 0x0, complete: false), and WCAG AA color contrast violations on the contact page header section. This document captures the bug conditions and expected fixes for both findings.
