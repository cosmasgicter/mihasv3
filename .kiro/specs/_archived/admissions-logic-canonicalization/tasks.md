...
- [x] 1. P0 — Identifier Canonicalization (Req 1, 2)
  - [x] 1.1 Create IdentifierResolver module
  ...
  - [x] 1.2 Write property tests for IdentifierResolver
  ...
  - [x] 1.3 Fix PaymentService program code resolution
  ...
  - [x] 1.4 Write property test for fee resolution round-trip
  ...
  - [x] 1.5 Add institution canonicalization to serializers
...
- [x] 3. P1 — Mutation Hardening (Req 3, 4)
  - [x] 3.1 Implement PATCH field restriction in ApplicationSerializer
  ...
  - [x] 3.2 Write property tests for PATCH field restriction
  ...
  - [x] 3.3 Add status check to ApplicationDetailView
  ...
  - [x] 3.4 Create DuplicateChecker module
  ...
  - [x] 3.5 Write property tests for DuplicateChecker
  ...
  - [x] 3.6 Integrate DuplicateChecker into views and services
...
- [x] 5. P2 — Rules & Readiness (Req 5, 6, 7, 8)
  - [x] 5.1 Create EligibilityEngine module
  ...
  - [x] 5.2 Write property tests for EligibilityEngine
  ...
  - [x] 5.3 Create IntakeEnforcer module
  ...
  - [x] 5.4 Write property tests for IntakeEnforcer
  ...
  - [x] 5.5 Integrate EligibilityEngine and IntakeEnforcer into submit_application
  ...
  - [x] 5.6 Write property test for draft deactivation
  ...
  - [x] 5.7 Unify payment status vocabulary
  ...
  - [x] 5.8 Write property tests for payment vocabulary
  ...
  - [x] 5.9 Update frontend payment status normalizer
  ...
  - [x] 5.10 Write frontend property test for payment normalization
  ...
  - [x] 5.11 Simplify frontend DraftManager for server-first drafts
  ...
  - [x] 5.12 Write frontend property test for draft conflict resolution
  ...
  - [x] 5.13 Update frontend duplicate check to use backend
...
- [x] 7. P3 — Intelligence & Automation (Req 9, 10, 11, 12)
  - [x] 7.1 Create DocumentIntelligence module
  ...
  - [x] 7.2 Write property tests for DocumentIntelligence
  ...
  - [x] 7.3 Create NotificationAutomation Celery tasks
  ...
  - [x] 7.4 Write property tests for notification deduplication
  ...
  - [x] 7.5 Register notification tasks in Celery Beat schedule
  ...
  - [x] 7.6 Create ReviewQueueScorer module
  ...
  - [x] 7.7 Write property tests for ReviewQueueScorer
  ...
  - [x] 7.8 Integrate ReviewQueueScorer into application list API
  ...
  - [x] 7.9 Create AdmissionsAnalyticsService module
  ...
  - [x] 7.10 Write property tests for AnalyticsService
  ...
  - [x] 7.11 Wire FunnelAnalyticsView to live data
