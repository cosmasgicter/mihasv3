...
| API URL | https://api.mihas.edu.zm | Subdomain of production domain |
...
NEXT_PUBLIC_API_BASE_URL=https://api.mihas.edu.zm/api/v1
```
...
CSRF_TRUSTED_ORIGINS=https://apply.mihas.edu.zm
...
Base URL: `https://api.mihas.edu.zm/api/v1`
