...
EXPECTED_CSP_DIRECTIVES = {
    ...
    "font-src": {"'self'"},
    "connect-src": {"'self'", "data:", "https://api.beanola.com", "https://pay.lenco.co", "https://pay.sandbox.lenco.co", "https://api.lenco.co", "https://api.sandbox.lenco.co", "https://app.glitchtip.com", "https://*.r2.cloudflarestorage.com"},
