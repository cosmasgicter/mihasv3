          ...
          patterns: [
            ...
            },
            {
              group: [
                ...
                '@/components/ui/standalone-select',
                '@/components/ui/Radio',
              ],
              message: 'Deprecated UI module import blocked. Use canonical primitives from @/components/ui (Button, UnifiedLoader, Select, radio-group).',
            },
          ],
        },
      ],
