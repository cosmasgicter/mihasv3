...
export function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-white">
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col gap-8 rounded-[32px] border border-white/60 bg-card/80 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
              <div className="space-y-6 text-center sm:text-left">
                ...
                <div>
                  <h2 className="text-3xl font-semibold text-gray-900 sm:text-4xl">{title}</h2>
                  {description && (
