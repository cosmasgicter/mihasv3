  ...
  return (
    <PageTransition mode="fade">
      <div className="min-h-screen bg-background">
        ...
        <main className="container-responsive px-4 sm:px-6 lg:px-8 pt-28 pb-16">
          <ScrollReveal className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold gradient-text-primary mb-4">Contact Admissions</h1>
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <a
                    ...
                    onClick={() => handleTrack('contact_phone_katc_click', 'tel:+260966992299')}
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 hover:text-primary"
                    onClick={() => handleTrack('contact_phone_mihas_click', 'tel:+260961515151')}
                  >
                    <Phone className="h-4 w-4" />
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 hover:text-primary"
                    onClick={() => handleTrack('contact_email_click', 'mailto:info@mihas.edu.zm')}
                  >
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <form id="form" className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <p className="text-xs text-muted-foreground">This form records a measurable CTA event for admissions follow-up.</p>
                  </form>
                </CardContent>
              </Card>
            </div>
