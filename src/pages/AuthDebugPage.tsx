  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Auth Context */}
        <div className="bg-white dark:bg-gray-800 dark:bg-gray-200 p-6 rounded-lg shadow">
        ...
        <div className="bg-white dark:bg-gray-800 dark:bg-gray-200 p-6 rounded-lg shadow">
          ...
          <pre className="bg-gray-100 dark:bg-gray-800 dark:bg-gray-200 p-4 rounded overflow-auto text-xs">
