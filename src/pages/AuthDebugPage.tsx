      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-card p-6 rounded-lg shadow">
          ...
          <button 
            ...
            className="mb-4 px-4 py-2 bg-primary/5 text-white rounded hover:bg-primary"
          >
        ...
        <div className="bg-card p-6 rounded-lg shadow">
          ...
          <button 
            ...
            className="mb-4 px-4 py-2 bg-accent/10 text-white rounded hover:bg-success"
          >
        ...
        <div className="bg-card p-6 rounded-lg shadow">
          ...
          <button 
            onClick={testRefresh}
            className="mb-4 px-4 py-2 bg-secondary/5 text-white rounded hover:bg-secondary"
          >
            Test Refresh
          </button>
          {refreshResult && (
        ...
        <div className="bg-card p-6 rounded-lg shadow">
          ...
          <div className="space-x-4">
            <button 
              onClick={clearAll}
              className="px-4 py-2 bg-destructive/5 text-white rounded hover:bg-error"
            >
              Clear All Auth Data
            </button>
            <a 
              href="/auth/signin"
              className="inline-block px-4 py-2 bg-primary/5 text-white rounded hover:bg-primary"
            >
              Go to Sign In
            </a>
          </div>
