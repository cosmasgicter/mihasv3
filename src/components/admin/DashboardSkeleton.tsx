    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-4 sm:py-6 lg:py-8 space-y-6">
        <div className="bg-white dark:bg-gray-800/80 backdrop-blur rounded-2xl p-6 sm:p-8 shadow-lg animate-pulse">
          ...
          <div className="h-4 bg-gray-100 dark:bg-gray-800 rounded w-32 mb-6" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 space-y-4 animate-pulse">
