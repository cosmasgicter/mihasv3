...
export function EnhancedDashboard({
  ...
  if (!metrics) {
    return (
      <div className="bg-white dark:bg-gray-800 dark:bg-gray-200 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            {metrics.pendingApplications > 0 && (
              <div className="text-xs text-yellow-600 dark:text-yellow-400 dark:text-yellow-500 mt-2">Requires attention</div>
            )}
          </div>
        </motion.div>
