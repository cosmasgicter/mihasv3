      ...
      <div className="p-6 space-y-6">
        ...
        {isAdmin ? (
          <div className="pt-8 border-t border-gray-200 dark:border-gray-700 space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <Button
                  type="button"
            ...
            {documentPreview && (
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <pre className="mt-3 max-h-64 overflow-y-auto whitespace-pre-wrap text-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md p-3">
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
            <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800">
