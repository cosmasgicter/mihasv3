          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-900"><Calendar className="w-5 h-5" /> Date Range</label>
                <div className="space-y-2">
                  <input
                    type="date"
              ...
              {/* Program Filter */}
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-900"><GraduationCap className="w-5 h-5" /> Program</label>
                <select
                  value={programFilter}
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-900"><CreditCard className="w-5 h-5" /> Payment Status</label>
                <select
