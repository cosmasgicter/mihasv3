      ...
      <AnimatePresence>
        {showPanel && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 dark:bg-gray-200 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50"
          >
