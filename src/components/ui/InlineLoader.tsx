...
export function InlineLoader({
  ...
  const baseClasses = {
    ...
    minimal: 'flex items-center space-x-2 text-gray-600',
    card: 'flex items-center justify-center space-x-3 bg-gray-50 rounded-lg border border-gray-200 p-6'
  }
  ...
  return (
    ...
    >
      ...
      <span className={cn(
        'font-medium',
        variant === 'minimal' ? 'text-gray-600' : 'text-gray-700'
      )}>
        {message}
      </span>
    </motion.div>
