...
export function Badge({
  ...
  const variantClasses = {
    default: 'bg-gray-100 dark:bg-gray-800 dark:bg-gray-200 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700',
    ...
    warning: 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 dark:text-yellow-500 border border-yellow-200 dark:border-yellow-800',
