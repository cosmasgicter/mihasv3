...
export function Badge({
  ...
  const variantClasses = {
    default: 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 dark:text-gray-600 border border-gray-200 dark:border-gray-700 dark:border-gray-300',
