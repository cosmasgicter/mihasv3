          ...
          >
            ...
            <div className={`sticky top-0 z-10 p-4 sm:p-6 ${
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  onClick={onClose}
                  className="flex-shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-foreground hover:bg-black/5 transition-colors touch-manipulation"
