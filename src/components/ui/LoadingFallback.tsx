  ...
  if (timeoutReached) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <motion.div 
          className="text-center p-8 bg-white rounded-xl shadow-lg border border-gray-200 max-w-md"
        ...
        >
          ...
          <p className="text-gray-600 mb-4">Please check your internet connection and try refreshing the page.</p>
          <button 
