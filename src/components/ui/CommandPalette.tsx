    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <div className="p-4">
        ...
        <div className="space-y-1 max-h-[400px] overflow-y-auto">
          ...
          {filtered.length === 0 && (
            <p className="text-sm text-gray-900 text-center py-8">No commands found</p>
          )}
        </div>
        <div className="mt-4 pt-4 border-t border-border flex items-center justify-center gap-2 text-xs text-gray-900">
