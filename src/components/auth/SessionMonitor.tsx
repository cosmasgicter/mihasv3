...
export function SessionMonitor() {
  ...
  return (
    <>
      {showWarning && (
        <div className="fixed top-4 right-4 z-50 bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 rounded-lg p-4 shadow-lg max-w-sm">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0">
              <svg className="w-5 h-5 text-yellow-600 dark:text-yellow-400 dark:text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
