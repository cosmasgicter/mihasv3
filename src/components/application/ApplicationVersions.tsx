...
export function ApplicationVersions({ applicationId, onRestoreVersion }: ApplicationVersionsProps) {
  ...
  if (!showVersions) {
    return (
      <Button
        ...
        className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:text-gray-200 dark:text-gray-700"
      >
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 dark:bg-gray-200 rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[80vh] overflow-hidden">
