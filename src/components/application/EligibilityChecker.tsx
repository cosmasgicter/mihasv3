    ...
    return (
      <div className="bg-card rounded-lg shadow p-6">
        <div className="animate-pulse">
          ...
          <div className="h-8 bg-skeleton rounded mb-4"></div>
  ...
  if (!assessment) {
    return (
      <div className="bg-card rounded-lg shadow p-6">
        ...
        <p className="text-gray-900">Add subjects and grades to see eligibility status</p>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className={`rounded-lg border-2 p-6 ${getStatusColor(assessment.eligibility_status)}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          <div className="bg-card bg-opacity-50 rounded-lg p-3">
