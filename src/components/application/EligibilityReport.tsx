      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-secondary/5 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-900-secondary">Core Subjects</div>
            <div className="text-2xl font-bold text-secondary-foreground">
              {Math.round(assessment.detailed_breakdown.core_subjects_score)}%
            </div>
          </div>
          <div className="bg-muted rounded-lg p-4">
            <div className="text-sm font-medium text-gray-900">Weighted Total</div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-xs text-gray-900 uppercase">{req.type}</span>
                    </div>
                    <div className="font-medium text-gray-900 mb-1">{req.description}</div>
                    <div className="text-sm text-gray-900">{req.suggestion}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      {assessment.assessor_notes && (
        <div className="mb-8">
          ...
          <div className="bg-muted border border-border rounded-lg p-4">
            <p className="text-gray-900">{assessment.assessor_notes}</p>
          </div>
        </div>
      )}
