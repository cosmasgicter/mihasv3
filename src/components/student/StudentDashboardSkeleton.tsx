        ...
        <div className="bg-gradient-to-r from-gradient-from to-gradient-to rounded-2xl p-6 sm:p-8 text-white shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="space-y-3">
              ...
              <div className="h-5 w-72 sm:w-96 rounded-full bg-card/30 animate-pulse" />
            </div>
            <div className="space-y-2 text-right">
              <div className="h-12 w-16 sm:w-20 rounded-xl bg-card/40 animate-pulse ml-auto" />
              <div className="h-4 w-24 sm:w-28 rounded-full bg-card/30 animate-pulse ml-auto" />
            </div>
          </div>
        </div>
      </div>
