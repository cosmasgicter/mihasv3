        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-lg transition-colors duration-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-3 flex-1">
              ...
              <div className="h-4 w-64 rounded-full bg-gray-300 animate-pulse" />
              <div className="h-4 w-40 rounded-full bg-gray-300 animate-pulse" />
            </div>
            <div className="flex gap-3">
              <div className="h-10 w-32 rounded-lg bg-gray-200 animate-pulse" />
              <div className="h-10 w-32 rounded-lg bg-gray-300 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-card rounded-2xl shadow-lg border border-border transition-colors duration-200">
            ...
            <div className="px-6 py-4 border-b border-border bg-gradient-to-r from-muted to-primary/10">
              <div className="h-6 w-48 rounded-full bg-gray-200 animate-pulse" />
              <div className="mt-2 h-4 w-64 rounded-full bg-gray-300 animate-pulse" />
            </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <div className="h-5 w-20 rounded-full bg-gray-300 animate-pulse" />
                      </div>
                      <div className="space-y-2">
                        <div className="h-4 w-64 rounded-full bg-gray-300 animate-pulse" />
                        <div className="h-4 w-56 rounded-full bg-gray-300 animate-pulse" />
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              {Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="p-3 bg-muted rounded-xl space-y-2">
                  ...
                  <div className="h-4 w-full rounded-full bg-gray-300 animate-pulse" />
                </div>
              ))}
            </div>
            <div className="h-10 w-full rounded-xl bg-gray-300 animate-pulse mt-4" />
          </div>
            ...
            <div className="space-y-3">
              {Array.from({ length: 3 }).map((_, index) => (
                <div key={index} className="border-l-4 border-red-400 pl-4 p-3 bg-destructive/5/30 rounded-r-xl space-y-2">
                  <div className="h-4 w-3/4 rounded-full bg-gray-300 animate-pulse" />
                  <div className="h-3 w-1/2 rounded-full bg-gray-300 animate-pulse" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border p-6 transition-colors duration-200">
            ...
            <div className="space-y-3">
              {Array.from({ length: 3 }).map((_, index) => (
                <div key={index} className="h-10 w-full rounded-lg bg-gray-300 animate-pulse" />
              ))}
            </div>
          </div>
        </div>
