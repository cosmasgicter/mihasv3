...
**Steps**:
1. Browser 1: Login as admin at https://apply.mihas.edu.zm/admin
...
**Steps**:
1. Open https://apply.mihas.edu.zm/admin in Tab 1
2. Note current application count
3. Open https://apply.mihas.edu.zm in Tab 2
...
**Steps**:
1. Open https://apply.mihas.edu.zm on mobile device
...
**Steps**:
1. Open https://apply.mihas.edu.zm/admin
