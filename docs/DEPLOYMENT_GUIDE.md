...
# App Config
VITE_APP_NAME=MIHAS
VITE_APP_URL=https://apply.mihas.edu.zm
```
...
2. Site URL: `https://apply.mihas.edu.zm`
3. Redirect URLs: Add:
   - `https://apply.mihas.edu.zm/auth/callback`
   - `https://apply.mihas.edu.zm/admin`
   - `https://apply.mihas.edu.zm/student/dashboard`
