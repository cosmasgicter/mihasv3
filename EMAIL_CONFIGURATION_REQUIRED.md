...
SMTP Port: 465
SMTP Username: admin@mihas.edu.zm
SMTP Password: Skyl3r@L0m1s
Enable SSL: Yes
Sender Email: admin@mihas.edu.zm
...
- Zoho SMTP: admin@mihas.edu.zm (credentials in .env)
- Resend API: admissions@mihas.edu.zm (for app emails)
