...
echo "========================================"
echo "🌐 Testing against: https://apply.mihas.edu.zm"
...
- **Test Target**: https://apply.mihas.edu.zm
...
- API Base URL: https://apply.mihas.edu.zm
...
echo "🔒 Production Environment: https://apply.mihas.edu.zm"
