...
netlify env:set VITE_APP_BASE_URL "https://apply.mihas.edu.zm"
...
netlify env:set EMAIL_FROM "admissions@mihas.edu.zm"
netlify env:set RESEND_API_KEY "re_cT8PNR7g_HT72NPZNFRpYmvPnZLYa5n1e"
netlify env:set RESEND_FROM_EMAIL "MIHAS Admissions <admissions@mihas.edu.zm>"
netlify env:set APPLICATION_ADMIN_EMAILS "admissions@mihas.edu.zm"

# SMTP Configuration (Zoho - Alternative)
netlify env:set SMTP_HOST "smtp.zoho.com"
netlify env:set SMTP_PORT "465"
netlify env:set SMTP_USERNAME "admin@mihas.edu.zm"
netlify env:set SMTP_PASSWORD "Skyl3r@L0m1s"
netlify env:set SMTP_SECURE "true"
netlify env:set SMTP_FROM_EMAIL "MIHAS Admissions <admin@mihas.edu.zm>"
...
# Email Fallbacks
netlify env:set DEFAULT_FROM_EMAIL "admissions@mihas.edu.zm"
netlify env:set EMAIL_FROM_ADDRESS "admissions@mihas.edu.zm"
